...
public class Companies_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Companies_Adapter(List<Catohries_Model> orderlist, Context context) {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        public CompanyRowBinding binding;

        public EventHolder(@NonNull CompanyRowBinding binding) {
