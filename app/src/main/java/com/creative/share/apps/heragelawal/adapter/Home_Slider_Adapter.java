...
public class Home_Slider_Adapter extends PagerAdapter {
    ...
    public Home_Slider_Adapter(List<Catohries_Model> imageList, Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        SliderHomeBinding rowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.slider_home,container,false);
