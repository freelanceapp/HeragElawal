...
public class Companies_Slider_Adapter extends PagerAdapter {
    private List<Catohries_Model> imageList;
    private Context context;

    public Companies_Slider_Adapter(List<Catohries_Model> imageList, Context context) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        SliderCompaniesBinding rowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.slider_companies,container,false);
