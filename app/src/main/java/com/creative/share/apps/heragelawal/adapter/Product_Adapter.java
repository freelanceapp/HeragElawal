...
import com.creative.share.apps.heragelawal.databinding.ProductRowBinding;
...
public class Product_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Product_Adapter(List<Catohries_Model> orderlist, Context context) {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        ...
        public EventHolder(@NonNull ProductRowBinding binding) {
